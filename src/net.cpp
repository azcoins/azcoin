...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Azcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"azcointools.com", "dnsseed.azcointools.com"},
    {"azcoinpool.org", "dnsseed.azcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"azcointools.com", "testnet-seed.azcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Azcoin is probably already running."), addrBind.ToString().c_str());
        else
